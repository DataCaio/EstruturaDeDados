// TP3/include/SistemaLogistico.hpp
...
private:
    ...
    void processarConsultaCL(int dataHoraConsulta, const std::string& nomeCliente);
    void processarConsultaPC(int dataHoraConsulta, int idPacote);
